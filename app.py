...
STATUSES = ["draft", "quoted", "approved", "fulfilled"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="Custom Invoice Generator",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="Business & Commerce",
        ENTITY_SINGULAR="Custom Invoice Order",
        ENTITY_PLURAL="Custom Invoice Orders",
    )
